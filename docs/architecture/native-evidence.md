...
| Nested measured artifacts | Accepted within discovery limits. `Full versioned capture` links the catalog-relative discovered path, not a reconstructed `id.json` basename. |
